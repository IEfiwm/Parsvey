...
function Footer() {
  return (
    ...
    <div class="footer-right">
        <h3>ایمیل :</h3>
        <p> میتوانید ایمیل خود را ارسال کنید تا ما از طریق ایمیل با شما در ارتباط باشیم</p>
        <br/>
        <input type="email" className='inptemail' placeholder="لطفا ایمل خود را ئارد کید"/>
        <br/>
